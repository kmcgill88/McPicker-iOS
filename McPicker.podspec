...
Pod::Spec.new do |s|
  s.name             = 'McPicker'
  s.version          = '0.1.0'
  s.summary          = 'A short description of McPicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Kevin McGill/McPicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Kevin McGill' => 'kevin@mcgilldevtech.com' }
  s.source           = { :git => 'https://github.com/Kevin McGill/McPicker.git', :tag => s.version.to_s }
